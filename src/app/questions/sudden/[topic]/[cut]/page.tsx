...
export async function generateMetadata({
  ...
  return {
    title: `오픽 돌발주제 ${topicName} ${cutName} 답변 — 예상 질문과 모범답안 (IM·IH·AL 등급별)`,
    description: `오픽 돌발주제 ${topicName} ${cutName} 질문 등급별(IM·IH·AL) 맞춤 답안. ${qa.question.en}`,
  };
}
...
export default async function SuddenTopicCutPage({
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-16">
      ...
      <QAAnswerBlock qa={qa} viewerId={`sudden-qa-${qa.topic}-${qa.cut}`} />
    </div>
  );
}
