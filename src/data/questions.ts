...
export const comboTopics: QuestionTopic[] = [
  ...
  },
  {
    name: '쇼핑하기',
    questions: [
      { en: 'What kind of shopping do you usually do?', ko: '평소 어떤 쇼핑을 주로 하나요?' },
      {
        en: "How often do you go shopping, and what's your routine?",
        ko: '쇼핑을 얼마나 자주 가고, 보통 어떻게 하나요?',
      },
      {
        en: 'Tell me about a memorable shopping experience.',
        ko: '기억에 남는 쇼핑 경험을 이야기해 주세요.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        ko: '스포츠를 얼마나 자주 보고, 보통 어떻게 하나요?',
      },
      {
        en: 'Tell me about a memorable experience watching a sports game.',
        ko: '스포츠 경기를 보다가 있었던 기억에 남는 경험을 이야기해 주세요.',
      },
    ],
  },
  {
